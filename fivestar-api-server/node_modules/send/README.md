...
javascript:;# send(req, path, [options])
...
javascript:;# Custom directory index view
...
javascript:;# Serving from a root directory with custom error-handling
