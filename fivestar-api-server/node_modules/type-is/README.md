...
javascript:;# type = typeis(request, types)
...
javascript:;# typeis.hasBody(request)
...
javascript:;# type = typeis.is(mediaType, types)
...
javascript:;# Example body parser
