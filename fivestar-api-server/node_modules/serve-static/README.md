...
javascript:;# serveStatic(root, options)
...
javascript:;javascript:;# acceptRanges

Enable or disable accepting ranged requests, defaults to true.
Disabling this will not send `Accept-Ranges` and ignore the contents
of the `Range` request header.

javascript:;javascript:;# cacheControl

Enable or disable setting `Cache-Control` response header, defaults to
true. Disabling this will ignore the `immutable` and `maxAge` options.

javascript:;javascript:;# dotfiles
...
javascript:;javascript:;# etag

Enable or disable etag generation, defaults to true.

javascript:;javascript:;# extensions
...
javascript:;javascript:;# fallthrough
...
javascript:;javascript:;# lastModified

Enable or disable `Last-Modified` header, defaults to true. Uses the file
system's last modified value.

javascript:;javascript:;# maxAge
...
javascript:;javascript:;# setHeaders
...
javascript:;# Serve files with vanilla node.js http server
...
javascript:;# Serve all files as downloads
...
javascript:;# Serving using express

javascript:;javascript:; Simple
...
javascript:;javascript:; Multiple roots
...
javascript:;javascript:; Different settings for paths
