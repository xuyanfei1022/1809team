...
javascript:;# onFinished(res, listener)
...
javascript:;# onFinished(req, listener)
...
javascript:;# onFinished.isFinished(res)

Determine if `res` is already finished. This would be useful to check and
not even start certain operations if the response has already finished.

javascript:;# onFinished.isFinished(req)

Determine if `req` is already finished. This would be useful to check and
not even start certain operations if the request has already finished.

javascript:; Special Node.js requests

javascript:;# HTTP CONNECT method
...
javascript:;# HTTP Upgrade request
