...
javascript:;# var code = status(Integer || String)
...
javascript:;# status.STATUS_CODES
...
javascript:;# var msg = status[code]
...
javascript:;# var code = status[msg]
...
javascript:;# status.redirect[code]
